...
async def main():
    ...
    app.search.client.create_search_service = (
        lambda: FakeSearchService()
    )


    app.llm.runner.generate_structured = (
    ...
    print(
        "NODE OBSERVATION SMOKE TEST OK"
    )
